...
🌱 Currently expanding my work into Quantum Symmetry-Aware Anomaly Detection — leveraging Variational Quantum Circuits (VQC) and Grover-inspired search to detect symmetry violations in Post-Quantum Cryptographic (PQC) systems under fault injections, side-channel attacks, or hardware noise.
